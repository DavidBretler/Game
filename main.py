...
def rungame():
    ...
    wn.bgpic("draw\Gbg.gif")
    wn.setup(900, 900, 300, -10)
    # Register the shapes
    wn.register_shape("draw\invader.gif")
    wn.register_shape("draw\player.gif")
    wn.register_shape("draw\corona.gif")
    wn.register_shape(r"draw\vaxinBullet.gif")
    wn.register_shape("draw\drop.gif")
    wn.tracer(0)
    #  Draw border
    ...
    enemy_bullet.shape("draw\drop.gif")
    ...
    bullet.color("yellow")
    bullet.shape(r"draw\vaxinBullet.gif")
    bullet.speed(0)
    ...
    wn.listen()
    # background music
    playsound.playsound(r'sounds\bgm.wav', False)
    ...
    while True:
        ...
        for enemy in enemies:
            ...
            if isCollision(bullet, enemy):
                #  Reset the bullet
                playsound.playsound('sounds\scream.wav', False)
                bullet.hideturtle()
                bulletstate = "ready"
            ...
            if isCollision(player, enemy_bullet):
                playsound.playsound("sounds\explosion.wav", False)
                enemy_bullet.hideturtle()
                enemy_bullet_state = "ready"
                lives -= 1
                lives_pen.clear()
